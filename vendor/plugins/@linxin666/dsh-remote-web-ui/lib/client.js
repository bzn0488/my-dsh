window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/runner/work/dsh-web-ui/dsh-web-ui/packages/dsh-remote-web-ui/src/client/remote.module.css.mjs
		const css$1 = ".uw-Msq_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.uw-Msq_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.uw-Msq_trigger{width:36px;height:36px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,box-shadow .12s;display:inline-flex}.uw-Msq_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.uw-Msq_trigger:active:not(:disabled){background:var(--dsw-alias-interactive-bg-active)}.uw-Msq_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-2), 0 0 0 4px var(--dsw-alias-brand-primary);outline:none}.uw-Msq_trigger:disabled{opacity:.5;cursor:default}.uw-Msq_panel{z-index:1;box-sizing:border-box;background:var(--dsw-alias-bg-layer-2);width:560px;max-width:calc(100vw - 48px);max-height:calc(100vh - 48px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);border-radius:24px;flex-direction:column;gap:14px;padding:24px;font-size:14px;line-height:22px;display:flex;position:relative;overflow:auto}.uw-Msq_header{align-items:flex-start;gap:12px;display:flex}.uw-Msq_heading{flex:1;min-width:0}.uw-Msq_title{margin:0;font-size:18px;font-weight:600;line-height:26px}.uw-Msq_subtitle{color:var(--dsw-alias-label-secondary);margin:4px 0 0;font-size:13px}.uw-Msq_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,box-shadow .12s;display:inline-flex}.uw-Msq_close:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.uw-Msq_close:active:not(:disabled){background:var(--dsw-alias-interactive-bg-active)}.uw-Msq_close:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-2), 0 0 0 4px var(--dsw-alias-brand-primary);outline:none}.uw-Msq_close:disabled{opacity:.5;cursor:default}.uw-Msq_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:16px;flex-direction:column;align-items:center;gap:12px;padding:16px;display:flex}.uw-Msq_cardHeader{justify-content:space-between;align-items:center;gap:12px;width:100%;display:flex}.uw-Msq_cardTitle{font-weight:500}.uw-Msq_badge{white-space:nowrap;border-radius:999px;flex:none;align-items:center;gap:6px;min-width:0;padding:2px 10px;font-size:12px;line-height:18px;display:inline-flex}.uw-Msq_badge:before{content:\"\";background:currentColor;border-radius:50%;width:8px;height:8px}.uw-Msq_badge-waiting{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover)}.uw-Msq_badge-connected{color:var(--dsw-alias-state-success-primary);background:var(--dsw-alias-interactive-bg-hover)}.uw-Msq_badge-disconnected{color:var(--dsw-alias-state-warn-primary);background:var(--dsw-alias-interactive-bg-hover)}.uw-Msq_badge-stopped{color:var(--dsw-alias-state-error-primary);background:var(--dsw-alias-interactive-bg-hover)}.uw-Msq_badgePublic{color:var(--dsw-alias-brand-primary);background:var(--dsw-alias-interactive-bg-hover)}.uw-Msq_badges{flex:none;align-items:center;gap:6px;display:inline-flex}.uw-Msq_qrWrap{background:var(--dsw-alias-bg-base);border-radius:12px;justify-content:center;align-items:center;padding:12px;display:flex}.uw-Msq_qr{display:block}.uw-Msq_expired{color:var(--dsw-alias-state-error-primary);margin:0;font-size:13px}.uw-Msq_expiry{color:var(--dsw-alias-label-secondary);margin:0;font-size:12px}.uw-Msq_hint{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px}.uw-Msq_link{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-caption);font-family:var(--dsw-font-mono,ui-monospace, monospace);margin:0;font-size:12px;overflow:hidden}.uw-Msq_stoppedHint{color:var(--dsw-alias-state-error-primary);margin:0;font-size:13px}.uw-Msq_tunnelNote{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px}.uw-Msq_tunnelFailed{color:var(--dsw-alias-state-error-primary);margin:0;font-size:13px}.uw-Msq_actions{gap:8px;display:flex}.uw-Msq_action{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);height:34px;color:var(--dsw-alias-label-primary);cursor:pointer;white-space:nowrap;border-radius:10px;justify-content:center;align-items:center;gap:6px;padding:0 14px;font-size:13px;transition:background-color .12s,border-color .12s,box-shadow .12s;display:inline-flex}.uw-Msq_action:hover:not(:disabled){background:var(--dsw-alias-button-floating-hover)}.uw-Msq_action:active:not(:disabled){background:var(--dsw-alias-interactive-bg-active)}.uw-Msq_action:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-2), 0 0 0 4px var(--dsw-alias-brand-primary);outline:none}.uw-Msq_action:disabled{opacity:.5;cursor:default}.uw-Msq_banner{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:16px;padding:16px}.uw-Msq_bannerTitle{color:var(--dsw-alias-state-warn-primary);margin:0;font-weight:500}.uw-Msq_bannerHint{color:var(--dsw-alias-label-secondary);margin:6px 0 0;font-size:13px}.uw-Msq_notice{z-index:2000;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-width:min(420px,100vw - 32px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;padding:12px 16px;position:fixed;top:16px;left:50%;transform:translate(-50%)}.uw-Msq_noticeTitle{color:var(--dsw-alias-state-error-primary);margin:0;font-weight:500}.uw-Msq_noticeDetail{color:var(--dsw-alias-label-secondary);margin:4px 0 0;font-size:13px}.uw-Msq_addresses{border:none;margin:12px 0 0;padding:0}.uw-Msq_addresses legend{color:var(--dsw-alias-label-secondary);padding:0;font-size:13px}.uw-Msq_address{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;cursor:pointer;border-radius:6px;align-items:center;gap:8px;margin-top:6px;padding:4px 6px;font-size:13px;transition:background-color .12s;display:flex}.uw-Msq_address:hover{background:var(--dsw-alias-interactive-bg-hover)}.uw-Msq_address input:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-2), 0 0 0 4px var(--dsw-alias-brand-primary);border-radius:50%;outline:none}.uw-Msq_addressValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-secondary);flex:1;font-size:12px;overflow:hidden}.uw-Msq_addressHint{color:var(--dsw-alias-label-tertiary);margin:6px 0 0;font-size:12px}@media (prefers-reduced-motion:reduce){.uw-Msq_trigger,.uw-Msq_close,.uw-Msq_action,.uw-Msq_address{transition:none}}.uw-Msq_entryRow{flex:none;align-items:center;gap:6px;display:flex}.uw-Msq_entryRow[data-rail=rail]{flex-direction:column-reverse;gap:4px}.uw-Msq_updateStatus{margin:0;font-weight:600}.uw-Msq_updateDetail{color:var(--dsw-alias-label-secondary);margin:6px 0 0;font-size:13px}.uw-Msq_updateError{color:var(--dsw-alias-text-danger,var(--dsw-alias-label-primary));margin:0;font-weight:600}.uw-Msq_updateOutput{background:var(--dsw-alias-bg-layer-1);max-height:180px;color:var(--dsw-alias-label-secondary);white-space:pre-wrap;word-break:break-all;border-radius:10px;margin:10px 0 0;padding:10px 12px;font-size:12px;line-height:18px;overflow:auto}.uw-Msq_updateList{flex-direction:column;gap:6px;margin:12px 0 0;padding:0;list-style:none;display:flex}.uw-Msq_updateListItem{justify-content:space-between;align-items:baseline;gap:12px;font-size:13px;display:flex}.uw-Msq_updateListName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);overflow:hidden}.uw-Msq_updateListVersions{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;flex:none}.uw-Msq_updateActions{justify-content:flex-end;margin-top:16px;display:flex}.uw-Msq_updateRetry{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:10px;align-items:center;gap:6px;padding:8px 14px;font-size:13px;transition:background-color .12s,color .12s;display:inline-flex}.uw-Msq_updateRetry:hover{background:var(--dsw-alias-interactive-bg-active)}@media (prefers-reduced-motion:reduce){.uw-Msq_updateRetry{transition:none}}";
		...
		var remote_module_css_default = {
			"action": "uw-Msq_action",
			"actions": "uw-Msq_actions",
			"address": "uw-Msq_address",
			"addressHint": "uw-Msq_addressHint",
			"addressValue": "uw-Msq_addressValue",
			"addresses": "uw-Msq_addresses",
			"badge": "uw-Msq_badge",
			"badge-connected": "uw-Msq_badge-connected",
			"badge-disconnected": "uw-Msq_badge-disconnected",
			"badge-stopped": "uw-Msq_badge-stopped",
			"badge-waiting": "uw-Msq_badge-waiting",
			"badgePublic": "uw-Msq_badgePublic",
			"badges": "uw-Msq_badges",
			"banner": "uw-Msq_banner",
			"bannerHint": "uw-Msq_bannerHint",
			"bannerTitle": "uw-Msq_bannerTitle",
			"card": "uw-Msq_card",
			"cardHeader": "uw-Msq_cardHeader",
			"cardTitle": "uw-Msq_cardTitle",
			"close": "uw-Msq_close",
			"entryRow": "uw-Msq_entryRow",
			"expired": "uw-Msq_expired",
			"expiry": "uw-Msq_expiry",
			"header": "uw-Msq_header",
			"heading": "uw-Msq_heading",
			"hint": "uw-Msq_hint",
			"link": "uw-Msq_link",
			"mask": "uw-Msq_mask",
			"notice": "uw-Msq_notice",
			"noticeDetail": "uw-Msq_noticeDetail",
			"noticeTitle": "uw-Msq_noticeTitle",
			"overlay": "uw-Msq_overlay",
			"panel": "uw-Msq_panel",
			"qr": "uw-Msq_qr",
			"qrWrap": "uw-Msq_qrWrap",
			"stoppedHint": "uw-Msq_stoppedHint",
			"subtitle": "uw-Msq_subtitle",
			"title": "uw-Msq_title",
			"trigger": "uw-Msq_trigger",
			"tunnelFailed": "uw-Msq_tunnelFailed",
			"tunnelNote": "uw-Msq_tunnelNote",
			"updateActions": "uw-Msq_updateActions",
			"updateDetail": "uw-Msq_updateDetail",
			"updateError": "uw-Msq_updateError",
			"updateList": "uw-Msq_updateList",
			"updateListItem": "uw-Msq_updateListItem",
			"updateListName": "uw-Msq_updateListName",
			"updateListVersions": "uw-Msq_updateListVersions",
			"updateOutput": "uw-Msq_updateOutput",
			"updateRetry": "uw-Msq_updateRetry",
			"updateStatus": "uw-Msq_updateStatus"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/runner/work/dsh-web-ui/dsh-web-ui/packages/dsh-remote-web-ui/src/client/settings-card.module.css.mjs
		const css = ".AQSrBq_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:8px;list-style:none;transition:border-color .16s,background .16s;overflow:hidden}.AQSrBq_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.AQSrBq_header{cursor:pointer;text-align:left;width:100%;font:inherit;background:0 0;border:0;border-radius:8px;align-items:center;gap:8px;padding:10px 14px;transition:background-color .12s,box-shadow .12s;display:flex}.AQSrBq_header:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.AQSrBq_header:active:not(:disabled){background:var(--dsw-alias-interactive-bg-active)}.AQSrBq_header:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-3), 0 0 0 4px var(--dsw-alias-brand-primary);outline:none}.AQSrBq_header:disabled{opacity:.5;cursor:default}.AQSrBq_headText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.AQSrBq_name{color:var(--dsw-alias-label-primary);font-weight:600}.AQSrBq_description{color:var(--dsw-alias-label-tertiary);font-size:12px}.AQSrBq_pending{color:var(--dsw-alias-state-warn-primary);font-size:12px}.AQSrBq_chevron{color:var(--dsw-alias-label-tertiary);transition:transform .12s}.AQSrBq_chevronOpen{transform:rotate(180deg)}.AQSrBq_body{flex-direction:column;gap:14px;padding:0 14px 14px;display:flex}.AQSrBq_readOnly{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px}.AQSrBq_notExposed{color:var(--dsw-alias-state-warn-primary);margin:0;font-size:12px;line-height:1.5}.AQSrBq_footer{justify-content:flex-end;align-items:center;gap:8px;display:flex}.AQSrBq_failed{color:var(--dsw-alias-state-error-primary);margin:0 auto 0 0;font-size:12px}.AQSrBq_discard,.AQSrBq_save{font:inherit;cursor:pointer;border-radius:6px;padding:5px 12px;font-size:13px;transition:background-color .12s,border-color .12s,color .12s,box-shadow .12s}.AQSrBq_discard{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.AQSrBq_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.AQSrBq_discard:active:not(:disabled){background:var(--dsw-alias-interactive-bg-active)}.AQSrBq_discard:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-3), 0 0 0 4px var(--dsw-alias-brand-primary);outline:none}.AQSrBq_save{border:1px solid var(--dsw-alias-button-info-fill);background:var(--dsw-alias-button-info-fill);color:var(--dsw-alias-label-primary-foreground)}.AQSrBq_save:hover:not(:disabled){border-color:var(--dsw-alias-button-info-hover);background:var(--dsw-alias-button-info-hover)}.AQSrBq_save:active:not(:disabled){border-color:var(--dsw-alias-button-info-hover);background:var(--dsw-alias-button-info-hover);filter:brightness(.96)}.AQSrBq_save:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-3), 0 0 0 4px var(--dsw-alias-brand-primary);outline:none}.AQSrBq_discard:disabled,.AQSrBq_save:disabled{opacity:.5;cursor:default}.AQSrBq_field{flex-direction:column;gap:4px;display:flex}.AQSrBq_head{align-items:center;gap:8px;display:flex}.AQSrBq_label{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500}.AQSrBq_badges{align-items:center;gap:6px;display:flex}.AQSrBq_badge{background:var(--dsw-alias-interactive-bg-hover-accent);min-width:0;color:var(--dsw-alias-state-business-primary);white-space:nowrap;border-radius:999px;flex:none;padding:1px 6px;font-size:11px}.AQSrBq_reset{color:var(--dsw-alias-state-business-primary);cursor:pointer;background:0 0;border:0;border-radius:4px;flex:none;padding:1px 2px;font-size:11px;transition:background-color .12s,color .12s,box-shadow .12s}.AQSrBq_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.AQSrBq_reset:active:not(:disabled){background:var(--dsw-alias-interactive-bg-active)}.AQSrBq_reset:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-3), 0 0 0 4px var(--dsw-alias-brand-primary);outline:none}.AQSrBq_reset:disabled{opacity:.5;cursor:default}.AQSrBq_input,.AQSrBq_select{border:1px solid var(--dsw-alias-border-l2);font:inherit;color:var(--dsw-alias-label-primary);background:var(--dsw-specific-input-major);border-radius:6px;padding:6px 8px;font-size:13px;transition:border-color .12s,box-shadow .12s}.AQSrBq_input:focus-visible,.AQSrBq_select:focus-visible{border-color:var(--dsw-alias-brand-primary);box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-3), 0 0 0 4px var(--dsw-alias-brand-primary);outline:none}.AQSrBq_inputInvalid{border:1px solid var(--dsw-alias-state-error-primary);font:inherit;color:var(--dsw-alias-label-primary);border-radius:6px;padding:6px 8px;font-size:13px;transition:border-color .12s,box-shadow .12s}.AQSrBq_inputInvalid:focus-visible{border-color:var(--dsw-alias-state-error-primary);box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-3), 0 0 0 4px var(--dsw-alias-state-error-primary);outline:none}.AQSrBq_input:disabled,.AQSrBq_select:disabled{opacity:.6}.AQSrBq_hint{color:var(--dsw-alias-label-secondary);margin:0;font-size:12px}.AQSrBq_invalid{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}@media (prefers-reduced-motion:reduce){.AQSrBq_card,.AQSrBq_header,.AQSrBq_chevron,.AQSrBq_discard,.AQSrBq_save,.AQSrBq_reset,.AQSrBq_input,.AQSrBq_select,.AQSrBq_inputInvalid{transition:none}}";
		...
		var settings_card_module_css_default = {
			"badge": "AQSrBq_badge",
			"badges": "AQSrBq_badges",
			"body": "AQSrBq_body",
			"card": "AQSrBq_card",
			"cardOpen": "AQSrBq_cardOpen",
			"chevron": "AQSrBq_chevron",
			"chevronOpen": "AQSrBq_chevronOpen",
			"description": "AQSrBq_description",
			"discard": "AQSrBq_discard",
			"failed": "AQSrBq_failed",
			"field": "AQSrBq_field",
			"footer": "AQSrBq_footer",
			"head": "AQSrBq_head",
			"headText": "AQSrBq_headText",
			"header": "AQSrBq_header",
			"hint": "AQSrBq_hint",
			"input": "AQSrBq_input",
			"inputInvalid": "AQSrBq_inputInvalid",
			"invalid": "AQSrBq_invalid",
			"label": "AQSrBq_label",
			"name": "AQSrBq_name",
			"notExposed": "AQSrBq_notExposed",
			"pending": "AQSrBq_pending",
			"readOnly": "AQSrBq_readOnly",
			"reset": "AQSrBq_reset",
			"save": "AQSrBq_save",
			"select": "AQSrBq_select"
		};
		//#endregion
		...
		*/
		function apply(ctx) {
			...
			const settingsScope = ctx.settingsScope.bind({ namespace: REMOTE_WEB_UI_NS });
			const enabled = () => {
