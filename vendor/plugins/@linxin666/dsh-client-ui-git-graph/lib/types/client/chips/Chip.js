...
export function Chip({ icon, label, ariaLabel, open, onClick }) {
    return (_jsxs("button", { type: "button", "data-gitgraph-chip": true, className: cx(css.chip, open && css.chipOpen), onClick: onClick, "aria-label": ariaLabel, "aria-expanded": open, children: [icon, _jsx("span", { className: css.chipLabel, title: label, children: label }), _jsx(IconChevronDownOutline14, { className: css.chipChevron, size: 12 })] }));
}
