window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function listPreviewScopes() {
			...
			try {
				for (let i = 0; i < localStorage.length; i += 1) {
					...
					if (key === null || !key.startsWith("preview-ui:")) continue;
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/runner/work/dsh-web-ui/dsh-web-ui/packages/dsh-aionui-panel/src/client/styles/scm.module.css.mjs
		const css$4 = "._67NI4a_panel{flex-direction:column;height:100%;min-height:0;display:flex}._67NI4a_section{flex-direction:column;flex-shrink:0;min-height:0;display:flex}._67NI4a_sectionHeader{cursor:pointer;user-select:none;background:var(--aion-bg-1);flex-shrink:0;align-items:center;gap:6px;height:24px;padding:0 8px;display:flex}._67NI4a_sectionHeader:hover{background:var(--aion-bg-hover)}._67NI4a_sectionHeader:active{background:var(--aion-bg-active)}._67NI4a_sectionHeader:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}._67NI4a_sectionTitle{color:var(--aion-text-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;font-size:12px;font-weight:600;overflow:hidden}._67NI4a_sectionChevron{color:var(--aion-text-secondary);align-items:center;transition:transform .15s cubic-bezier(.4,0,.2,1);display:flex}._67NI4a_sectionChevronOpen{transform:rotate(90deg)}._67NI4a_sectionAction{width:22px;height:22px;color:var(--aion-text-secondary);cursor:pointer;background:0 0;border:none;border-radius:4px;flex-shrink:0;justify-content:center;align-items:center;padding:0;transition:background-color .15s cubic-bezier(.4,0,.2,1);display:flex}._67NI4a_sectionAction:hover{background:var(--aion-bg-3);color:var(--aion-text-primary)}._67NI4a_sectionAction:active{background:var(--aion-bg-active)}._67NI4a_sectionAction:focus-visible{outline:2px solid var(--aion-primary);outline-offset:2px}._67NI4a_sectionAction:disabled{opacity:.4;cursor:default}._67NI4a_sectionAction:disabled:hover{color:var(--aion-text-secondary);background:0 0}._67NI4a_sectionBody{flex-shrink:1;min-height:0;overflow:hidden auto}._67NI4a_branchRow{height:26px;color:var(--aion-text-primary);align-items:center;gap:6px;padding:0 8px 0 12px;font-size:13px;display:flex}._67NI4a_branchName{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._67NI4a_changeRow{cursor:pointer;white-space:nowrap;align-items:center;gap:6px;height:26px;padding:0 8px 0 12px;transition:background-color .12s;display:flex}._67NI4a_changeRow:hover{background:var(--aion-fill-2)}._67NI4a_changeRow:active{background:var(--aion-bg-active)}._67NI4a_changeRow:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}._67NI4a_changeRowSelected,._67NI4a_changeRowSelected:hover{background:var(--aion-fill-3)}._67NI4a_badge{width:16px;height:16px;font-size:11px;font-weight:600;font-family:var(--aion-font-mono);border-radius:3px;flex-shrink:0;justify-content:center;align-items:center;display:flex}._67NI4a_badgeCreated{color:var(--aion-success);background:color-mix(in srgb, var(--aion-success) 14%, transparent)}._67NI4a_badgeModified{color:var(--aion-warning);background:color-mix(in srgb, var(--aion-warning) 14%, transparent)}._67NI4a_badgeDeleted{color:var(--aion-danger);background:color-mix(in srgb, var(--aion-danger) 14%, transparent)}._67NI4a_badgeConflicted{color:var(--aion-danger);background:color-mix(in srgb, var(--aion-danger) 18%, transparent);border:1px solid var(--aion-danger)}._67NI4a_badgeUntracked{color:var(--aion-text-tertiary);background:var(--aion-fill-2)}._67NI4a_changeName{text-overflow:ellipsis;color:var(--aion-text-primary);flex:1;min-width:0;font-size:13px;overflow:hidden}._67NI4a_changeDir{text-overflow:ellipsis;color:var(--aion-text-tertiary);flex-shrink:1;min-width:0;font-size:11px;overflow:hidden}._67NI4a_rowActions{opacity:0;flex-shrink:0;align-items:center;gap:2px;transition:opacity .15s cubic-bezier(.4,0,.2,1);display:flex}._67NI4a_changeRow:hover ._67NI4a_rowActions,._67NI4a_changeRow:focus-within ._67NI4a_rowActions,._67NI4a_rowActionsVisible{opacity:1}._67NI4a_rowAction{width:22px;height:22px;color:var(--aion-text-secondary);cursor:pointer;background:0 0;border:none;border-radius:4px;justify-content:center;align-items:center;padding:0;transition:background-color .15s cubic-bezier(.4,0,.2,1);display:flex}._67NI4a_rowAction:hover{background:var(--aion-bg-3);color:var(--aion-text-primary)}._67NI4a_rowAction:active{background:var(--aion-bg-active)}._67NI4a_rowAction:focus-visible{outline:2px solid var(--aion-primary);outline-offset:2px}._67NI4a_rowAction:disabled{opacity:.4;cursor:default}._67NI4a_rowAction:disabled:hover{color:var(--aion-text-secondary);background:0 0}._67NI4a_rowFailed{color:var(--aion-danger)}._67NI4a_groupTitle{height:22px;color:var(--aion-text-tertiary);background:var(--aion-bg-2);flex-shrink:0;align-items:center;gap:6px;padding:0 8px 0 12px;font-size:11px;font-weight:600;display:flex}._67NI4a_groupAction{width:18px;height:18px;color:var(--aion-text-secondary);cursor:pointer;background:0 0;border:none;border-radius:3px;justify-content:center;align-items:center;padding:0;display:flex}._67NI4a_groupAction:hover{background:var(--aion-bg-3);color:var(--aion-text-primary)}._67NI4a_groupAction:active{background:var(--aion-bg-active)}._67NI4a_groupAction:focus-visible{outline:2px solid var(--aion-primary);outline-offset:2px}._67NI4a_groupAction:disabled{opacity:.4;cursor:default}._67NI4a_groupAction:disabled:hover{color:var(--aion-text-secondary);background:0 0}._67NI4a_dirRow{cursor:pointer;white-space:nowrap;align-items:center;gap:4px;height:26px;transition:background-color .12s;display:flex}._67NI4a_dirRow:hover{background:var(--aion-fill-2)}._67NI4a_dirRow:active{background:var(--aion-bg-active)}._67NI4a_dirRow:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}._67NI4a_dirArrow{color:var(--aion-text-tertiary);align-items:center;transition:transform .15s cubic-bezier(.4,0,.2,1);display:flex}._67NI4a_dirArrowOpen{transform:rotate(90deg)}._67NI4a_empty,._67NI4a_loading{color:var(--aion-text-tertiary);padding:16px 12px;font-size:12px}._67NI4a_notRepo{color:var(--aion-text-tertiary);padding:16px 12px;font-size:12px;line-height:1.6}";
		...
		var scm_module_css_default = {
			"badge": "_67NI4a_badge",
			"badgeConflicted": "_67NI4a_badgeConflicted",
			"badgeCreated": "_67NI4a_badgeCreated",
			"badgeDeleted": "_67NI4a_badgeDeleted",
			"badgeModified": "_67NI4a_badgeModified",
			"badgeUntracked": "_67NI4a_badgeUntracked",
			"branchName": "_67NI4a_branchName",
			"branchRow": "_67NI4a_branchRow",
			"changeDir": "_67NI4a_changeDir",
			"changeName": "_67NI4a_changeName",
			"changeRow": "_67NI4a_changeRow",
			"changeRowSelected": "_67NI4a_changeRowSelected",
			"dirArrow": "_67NI4a_dirArrow",
			"dirArrowOpen": "_67NI4a_dirArrowOpen",
			"dirRow": "_67NI4a_dirRow",
			"empty": "_67NI4a_empty",
			"groupAction": "_67NI4a_groupAction",
			"groupTitle": "_67NI4a_groupTitle",
			"loading": "_67NI4a_loading",
			"notRepo": "_67NI4a_notRepo",
			"panel": "_67NI4a_panel",
			"rowAction": "_67NI4a_rowAction",
			"rowActions": "_67NI4a_rowActions",
			"rowActionsVisible": "_67NI4a_rowActionsVisible",
			"rowFailed": "_67NI4a_rowFailed",
			"section": "_67NI4a_section",
			"sectionAction": "_67NI4a_sectionAction",
			"sectionBody": "_67NI4a_sectionBody",
			"sectionChevron": "_67NI4a_sectionChevron",
			"sectionChevronOpen": "_67NI4a_sectionChevronOpen",
			"sectionHeader": "_67NI4a_sectionHeader",
			"sectionTitle": "_67NI4a_sectionTitle"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/runner/work/dsh-web-ui/dsh-web-ui/packages/dsh-aionui-panel/src/client/styles/explorer.module.css.mjs
		const css$3 = ".HWMuMq_tabBar{border-bottom:1px solid var(--aion-bg-3);background:var(--aion-bg-1);flex-shrink:0;align-items:center;gap:4px;padding:4px 8px 4px 12px;display:flex;position:relative}.HWMuMq_tabBtn{height:28px;color:var(--aion-text-secondary);font-size:13px;font-family:var(--aion-font-sans);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:2px;padding:0 8px;transition:background-color .15s cubic-bezier(.4,0,.2,1)}.HWMuMq_tabBtn:hover{background:var(--aion-fill-2)}.HWMuMq_tabBtn:active{background:var(--aion-bg-active)}.HWMuMq_tabBtn:focus-visible{outline:2px solid var(--aion-primary);outline-offset:2px}.HWMuMq_tabBtnActive{background:var(--aion-bg-2);height:28px;color:var(--aion-text-primary);font-size:13px;font-family:var(--aion-font-sans);cursor:pointer;white-space:nowrap;border:none;border-radius:2px;padding:0 8px;font-weight:500;transition:background-color .15s cubic-bezier(.4,0,.2,1)}.HWMuMq_tabBtnActive:active{background:var(--aion-bg-active)}.HWMuMq_tabBtnActive:focus-visible{outline:2px solid var(--aion-primary);outline-offset:2px}.HWMuMq_searchArea{flex-shrink:0;padding:8px 8px 4px 12px}.HWMuMq_searchBox{background:var(--aion-bg-base);border:1px solid #0000;border-radius:2px;align-items:center;gap:6px;height:28px;padding:0 8px;transition:border-color .15s cubic-bezier(.4,0,.2,1);display:flex}.HWMuMq_searchBoxFocus{border-color:var(--aion-primary)}.HWMuMq_searchBox:focus-within{box-shadow:0 0 0 2px transparent, 0 0 0 4px var(--aion-primary)}.HWMuMq_searchIcon{color:var(--aion-text-secondary);flex-shrink:0;align-items:center;display:flex}.HWMuMq_searchInput{min-width:0;height:100%;color:var(--aion-text-primary);font-size:13px;font-family:var(--aion-font-sans);background:0 0;border:none;outline:none;flex:1}.HWMuMq_searchInput::placeholder{color:var(--aion-text-tertiary)}.HWMuMq_searchClear{width:16px;height:16px;color:var(--aion-text-tertiary);cursor:pointer;background:0 0;border:none;border-radius:2px;justify-content:center;align-items:center;padding:0;display:none}.HWMuMq_searchClear:hover{color:var(--aion-text-primary);background:var(--aion-fill-2)}.HWMuMq_searchClear:active{background:var(--aion-bg-active)}.HWMuMq_searchClear:focus-visible{outline:2px solid var(--aion-primary);outline-offset:2px}.HWMuMq_searchAreaFocus .HWMuMq_searchClear{display:flex}.HWMuMq_scrollArea{flex:1;min-height:0;overflow:hidden auto}.HWMuMq_tree{user-select:none;padding:2px 0 8px 12px}.HWMuMq_treeRow{cursor:pointer;white-space:nowrap;border-radius:0;align-items:center;gap:4px;min-width:0;height:34px;padding-right:8px;transition:background-color .12s;display:flex}.HWMuMq_treeRow:hover{background-color:var(--aion-fill-2)}.HWMuMq_treeRow:active{background-color:var(--aion-bg-active)}.HWMuMq_treeRowDragging{cursor:grabbing;opacity:.55}.HWMuMq_treeRow:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}.HWMuMq_treeRowSelected,.HWMuMq_treeRowSelected:hover{background-color:var(--aion-fill-3)}.HWMuMq_treeArrow{width:14px;height:14px;color:var(--aion-text-tertiary);flex-shrink:0;justify-content:center;align-items:center;transition:transform .15s cubic-bezier(.4,0,.2,1);display:flex}.HWMuMq_treeArrowOpen{transform:rotate(90deg)}.HWMuMq_treeArrowEmpty{visibility:hidden}.HWMuMq_treeName{text-overflow:ellipsis;color:var(--aion-text-primary);font-size:13px;overflow:hidden}.HWMuMq_treeRowSelected .HWMuMq_treeName{color:var(--aion-text-primary)}.HWMuMq_treeMeta{color:var(--aion-text-tertiary);flex-shrink:0;margin-left:auto;padding-right:4px;font-size:11px}.HWMuMq_resultRow{cursor:pointer;white-space:nowrap;align-items:center;gap:6px;height:30px;padding:0 8px 0 12px;transition:background-color .12s;display:flex}.HWMuMq_resultRow:hover{background-color:var(--aion-fill-2)}.HWMuMq_resultRow:active{background-color:var(--aion-bg-active)}.HWMuMq_resultRow:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}.HWMuMq_resultName{text-overflow:ellipsis;color:var(--aion-text-primary);font-size:13px;overflow:hidden}.HWMuMq_resultPath{text-overflow:ellipsis;color:var(--aion-text-tertiary);flex-shrink:1;min-width:0;font-size:11px;overflow:hidden}.HWMuMq_resultMeta{color:var(--aion-text-tertiary);flex-shrink:0;font-size:11px}.HWMuMq_searchStatus{color:var(--aion-text-tertiary);padding:12px;font-size:12px}.HWMuMq_emptyState{color:var(--aion-text-tertiary);text-align:center;padding:24px 16px;font-size:12px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/runner/work/dsh-web-ui/dsh-web-ui/packages/dsh-aionui-panel/src/client/styles/preview.module.css.mjs
		const css$1 = ".yoKs8G_panel{background:var(--aion-bg-1);flex-direction:column;height:100%;min-height:0;display:flex}.yoKs8G_tabBar{background:var(--aion-bg-2);border-bottom:1px solid var(--aion-bg-3);flex-shrink:0;align-items:stretch;height:36px;display:flex;position:relative}.yoKs8G_tabScroll{scrollbar-width:none;flex:1;align-items:stretch;min-width:0;display:flex;overflow:auto hidden}.yoKs8G_tabScroll::-webkit-scrollbar{display:none}.yoKs8G_tab{cursor:pointer;user-select:none;border-right:1px solid #0000;flex-shrink:0;align-items:center;gap:6px;max-width:180px;height:100%;padding:0 10px;transition:background-color .15s cubic-bezier(.4,0,.2,1);display:flex}.yoKs8G_tabActive{background:var(--aion-bg-1);color:var(--aion-text-primary)}.yoKs8G_tabInactive{color:var(--aion-text-secondary)}.yoKs8G_tabInactive:hover{background:var(--aion-bg-3)}.yoKs8G_tab:active{background:var(--aion-bg-active)}.yoKs8G_tab:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}.yoKs8G_tabTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.yoKs8G_tabFavicon{object-fit:contain;border-radius:2px;flex-shrink:0;width:12px;height:12px}.yoKs8G_tabDot{border-radius:9999px;flex-shrink:0;width:6px;height:6px}.yoKs8G_tabDotDirty{background:var(--aion-primary);border-radius:9999px;flex-shrink:0;width:6px;height:6px}.yoKs8G_tabDotAgent{background:var(--aion-success);border-radius:9999px;flex-shrink:0;width:6px;height:6px;animation:1.6s ease-in-out infinite yoKs8G_aionui-pulse}@keyframes yoKs8G_aionui-pulse{0%,to{opacity:1}50%{opacity:.4}}.yoKs8G_tabClose{width:16px;height:16px;color:var(--aion-text-secondary);border-radius:4px;flex-shrink:0;justify-content:center;align-items:center;transition:background-color .15s cubic-bezier(.4,0,.2,1);display:flex}.yoKs8G_tabClose:hover{background:var(--aion-bg-3);color:var(--aion-text-primary)}.yoKs8G_tabClose:active{background:var(--aion-bg-active)}.yoKs8G_tabClose:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}.yoKs8G_tabPlus{width:24px;height:24px;color:var(--aion-text-secondary);cursor:pointer;border-radius:4px;flex-shrink:0;justify-content:center;align-self:center;align-items:center;margin:0 4px;transition:background-color .15s cubic-bezier(.4,0,.2,1);display:flex}.yoKs8G_tabPlus:hover{background:var(--aion-bg-3);color:var(--aion-text-primary)}.yoKs8G_tabPlus:active{background:var(--aion-bg-active)}.yoKs8G_tabPlus:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}.yoKs8G_tabBarRight{flex-shrink:0;align-items:center;padding:0 10px;display:flex}.yoKs8G_panelCollapse{width:20px;height:20px;color:var(--aion-text-secondary);cursor:pointer;border-radius:4px;justify-content:center;align-items:center;transition:background-color .15s cubic-bezier(.4,0,.2,1);display:flex}.yoKs8G_panelCollapse:hover{background:var(--aion-bg-3);color:var(--aion-text-primary)}.yoKs8G_panelCollapse:active{background:var(--aion-bg-active)}.yoKs8G_panelCollapse:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}.yoKs8G_tabFade{pointer-events:none;z-index:2;width:32px;position:absolute;top:0;bottom:0}.yoKs8G_tabFadeLeft{pointer-events:none;z-index:2;background:linear-gradient(90deg, var(--aion-bg-2) 0%, transparent 100%);width:32px;position:absolute;top:0;bottom:0;left:0}.yoKs8G_tabFadeRight{pointer-events:none;z-index:2;background:linear-gradient(270deg, var(--aion-bg-2) 0%, transparent 100%);width:32px;position:absolute;top:0;bottom:0;right:0}.yoKs8G_noTabs{color:var(--aion-text-tertiary);align-items:center;padding:0 10px;font-size:12px;display:flex}.yoKs8G_toolbar{background:var(--aion-bg-2);border-bottom:1px solid var(--aion-bg-3);scrollbar-width:none;flex-shrink:0;align-items:center;gap:2px;height:32px;padding:0 10px;display:flex;overflow-x:auto}.yoKs8G_toolbar::-webkit-scrollbar{display:none}.yoKs8G_toolbarSpacer{flex:1}.yoKs8G_toolbarBtn{height:24px;color:var(--aion-text-secondary);font-size:12px;font-family:var(--aion-font-sans);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:4px;flex-shrink:0;align-items:center;gap:4px;padding:0 8px;transition:background-color .15s cubic-bezier(.4,0,.2,1),color .15s cubic-bezier(.4,0,.2,1);display:flex}.yoKs8G_toolbarBtn:hover{background:var(--aion-bg-3);color:var(--aion-text-primary)}.yoKs8G_toolbarBtn:active{background:var(--aion-bg-active);color:var(--aion-text-primary)}.yoKs8G_toolbarBtn:focus-visible{outline:2px solid var(--aion-primary);outline-offset:2px}.yoKs8G_toolbarBtn:disabled{opacity:.4;cursor:default}.yoKs8G_toolbarBtn:disabled:hover{color:var(--aion-text-secondary);background:0 0}.yoKs8G_toolbarBtnActive{color:var(--aion-brand);background:var(--aion-aou-2);border-bottom:4px solid var(--aion-brand)}.yoKs8G_toolbarBtnWarn{color:var(--aion-warning)}.yoKs8G_content{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.yoKs8G_mdViewer{min-height:0;color:var(--aion-text-primary);word-wrap:break-word;flex:1;padding:16px 20px 32px;font-size:15px;line-height:1.7;overflow:hidden auto}.yoKs8G_mdViewer h1{border-bottom:1px solid var(--aion-bg-3);margin:24px 0 12px;padding-bottom:8px;font-size:24px;font-weight:600;line-height:1.3}.yoKs8G_mdViewer h1:first-child{margin-top:4px}.yoKs8G_mdViewer h2{margin:22px 0 10px;font-size:20px;font-weight:600;line-height:1.3}.yoKs8G_mdViewer h3{margin:18px 0 8px;font-size:17px;font-weight:600;line-height:1.3}.yoKs8G_mdViewer h4,.yoKs8G_mdViewer h5,.yoKs8G_mdViewer h6{margin:14px 0 6px;font-size:15px;font-weight:600;line-height:1.3}.yoKs8G_mdViewer p{margin:8px 0}.yoKs8G_mdViewer ul,.yoKs8G_mdViewer ol{margin:8px 0;padding-left:24px}.yoKs8G_mdViewer li{margin:3px 0}.yoKs8G_mdViewer code{font-family:var(--aion-font-mono);background:var(--aion-bg-2);color:var(--aion-text-primary);border-radius:3px;padding:1px 5px;font-size:.9em}.yoKs8G_mdViewer pre{background:var(--aion-bg-2);border-radius:6px;margin:10px 0;padding:12px 14px;line-height:1.5;overflow-x:auto}.yoKs8G_mdViewer pre code{color:var(--aion-text-primary);background:0 0;padding:0;font-size:13px}.yoKs8G_mdViewer blockquote{border-left:3px solid var(--aion-bg-3);color:var(--aion-text-secondary);margin:10px 0;padding:4px 14px}.yoKs8G_mdViewer blockquote p{margin:4px 0}.yoKs8G_mdViewer a{color:var(--aion-primary);text-decoration:none}.yoKs8G_mdViewer a:hover{text-decoration:underline}.yoKs8G_mdViewer hr{border:none;border-top:1px solid var(--aion-bg-3);margin:20px 0}.yoKs8G_mdViewer table{border-collapse:collapse;width:100%;margin:10px 0;font-size:14px}.yoKs8G_mdViewer th,.yoKs8G_mdViewer td{border:1px solid var(--aion-bg-3);text-align:left;padding:6px 10px}.yoKs8G_mdViewer th{background:var(--aion-bg-2);font-weight:600}.yoKs8G_mdViewer img{border-radius:4px;max-width:100%}.yoKs8G_codeViewer{min-height:0;font-family:var(--aion-font-mono);color:var(--aion-text-primary);tab-size:2;white-space:pre;flex:1;margin:0;padding:12px 14px;font-size:13px;line-height:1.6;overflow:auto}.yoKs8G_diffViewer{min-height:0;font-family:var(--aion-font-mono);flex:1;padding:4px 0 16px;font-size:12.5px;line-height:1.55;overflow:auto}.yoKs8G_diffLine{white-space:pre;min-height:20px;padding:0 12px;display:flex}.yoKs8G_diffLineAdd{background:color-mix(in srgb, var(--aion-success) 12%, transparent);color:var(--aion-text-primary)}.yoKs8G_diffLineDel{background:color-mix(in srgb, var(--aion-danger) 12%, transparent);color:var(--aion-text-primary)}.yoKs8G_diffLineHunk{background:color-mix(in srgb, var(--aion-primary) 10%, transparent);color:var(--aion-text-secondary)}.yoKs8G_diffLineMeta{color:var(--aion-text-tertiary)}.yoKs8G_csvViewer{flex:1;min-height:0;padding:12px;overflow:auto}.yoKs8G_csvTable{border-collapse:collapse;font-size:13px;font-family:var(--aion-font-mono)}.yoKs8G_csvTable th,.yoKs8G_csvTable td{border:1px solid var(--aion-bg-3);white-space:nowrap;text-overflow:ellipsis;max-width:480px;padding:4px 10px;overflow:hidden}.yoKs8G_csvTable th{background:var(--aion-bg-2);font-weight:600;position:sticky;top:0}.yoKs8G_imageViewer{background:var(--aion-bg-base);flex:1;justify-content:center;align-items:center;min-height:0;padding:16px;display:flex;overflow:auto}.yoKs8G_imageViewer img{object-fit:contain;border-radius:2px;max-width:100%;max-height:100%}.yoKs8G_imageMeta{color:var(--aion-text-tertiary);background:var(--aion-bg-2);border-radius:9999px;padding:2px 10px;font-size:11px;position:absolute;bottom:12px;left:50%;transform:translate(-50%)}.yoKs8G_pdfViewer{background:var(--aion-bg-base);border:none;flex:1;min-height:0}.yoKs8G_urlBar{background:var(--aion-bg-2);border-bottom:1px solid var(--aion-bg-3);flex-shrink:0;align-items:center;gap:6px;height:32px;padding:0 10px;display:flex}.yoKs8G_urlInput{background:var(--aion-bg-base);min-width:0;height:24px;color:var(--aion-text-primary);font-size:12px;font-family:var(--aion-font-sans);border:none;border-radius:4px;outline:none;flex:1;padding:0 8px}.yoKs8G_urlInput:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}.yoKs8G_urlFrame{background:var(--aion-bg-base);border:none;flex:1;width:100%;min-height:0}.yoKs8G_placeholder{min-height:0;color:var(--aion-text-secondary);text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;gap:8px;padding:24px;font-size:13px;display:flex}.yoKs8G_placeholderTitle{color:var(--aion-text-primary);font-size:14px;font-weight:500}.yoKs8G_placeholderMeta{color:var(--aion-text-tertiary);font-size:12px}.yoKs8G_placeholderError{color:var(--aion-danger);font-size:12px}.yoKs8G_splitPane{flex:1;min-height:0;display:flex;position:relative;overflow:hidden}.yoKs8G_splitPaneLeft,.yoKs8G_splitPaneRight{flex-direction:column;min-width:0;height:100%;display:flex}.yoKs8G_splitHeader{background:var(--aion-bg-2);height:40px;color:var(--aion-text-secondary);border-bottom:1px solid var(--aion-bg-3);flex-shrink:0;align-items:center;padding:0 12px;font-size:12px;display:flex}.yoKs8G_splitBody{flex:1;min-height:0;overflow:hidden}.yoKs8G_splitHandle{z-index:20;cursor:col-resize;touch-action:none;width:12px;position:absolute;top:0;bottom:0}.yoKs8G_splitHandle:after{content:\"\";background:var(--aion-bg-3);opacity:.9;pointer-events:none;border-radius:9999px;width:2px;transition:width .15s cubic-bezier(.4,0,.2,1),background-color .15s cubic-bezier(.4,0,.2,1);position:absolute;top:0;bottom:0;left:50%;transform:translate(-50%)}.yoKs8G_splitHandle:hover:after,.yoKs8G_splitHandle:active:after{background:var(--aion-brand);width:6px}.yoKs8G_textEditor{resize:none;background:var(--aion-bg-base);width:100%;height:100%;color:var(--aion-text-primary);font-family:var(--aion-font-mono);tab-size:2;border:none;outline:none;padding:12px 14px;font-size:13px;line-height:1.6}.yoKs8G_textEditor:focus-visible{box-shadow:inset 0 0 0 2px var(--aion-primary)}.yoKs8G_saveBanner{z-index:5;background:var(--aion-bg-2);border:1px solid var(--aion-bg-3);color:var(--aion-text-secondary);text-overflow:ellipsis;white-space:nowrap;border-radius:4px;max-width:60%;padding:4px 10px;font-size:12px;position:absolute;top:8px;right:12px;overflow:hidden}.yoKs8G_saveBannerError{color:var(--aion-danger);border-color:var(--aion-danger)}.yoKs8G_truncatedNote{color:var(--aion-warning);background:color-mix(in srgb, var(--aion-warning) 10%, transparent);flex-shrink:0;padding:6px 20px;font-size:12px}";
		...
		var preview_module_css_default = {
			"aionui-pulse": "yoKs8G_aionui-pulse",
			"codeViewer": "yoKs8G_codeViewer",
			"content": "yoKs8G_content",
			"csvTable": "yoKs8G_csvTable",
			"csvViewer": "yoKs8G_csvViewer",
			"diffLine": "yoKs8G_diffLine",
			"diffLineAdd": "yoKs8G_diffLineAdd",
			"diffLineDel": "yoKs8G_diffLineDel",
			"diffLineHunk": "yoKs8G_diffLineHunk",
			"diffLineMeta": "yoKs8G_diffLineMeta",
			"diffViewer": "yoKs8G_diffViewer",
			"imageMeta": "yoKs8G_imageMeta",
			"imageViewer": "yoKs8G_imageViewer",
			"mdViewer": "yoKs8G_mdViewer",
			"noTabs": "yoKs8G_noTabs",
			"panel": "yoKs8G_panel",
			"panelCollapse": "yoKs8G_panelCollapse",
			"pdfViewer": "yoKs8G_pdfViewer",
			"placeholder": "yoKs8G_placeholder",
			"placeholderError": "yoKs8G_placeholderError",
			"placeholderMeta": "yoKs8G_placeholderMeta",
			"placeholderTitle": "yoKs8G_placeholderTitle",
			"saveBanner": "yoKs8G_saveBanner",
			"saveBannerError": "yoKs8G_saveBannerError",
			"splitBody": "yoKs8G_splitBody",
			"splitHandle": "yoKs8G_splitHandle",
			"splitHeader": "yoKs8G_splitHeader",
			"splitPane": "yoKs8G_splitPane",
			"splitPaneLeft": "yoKs8G_splitPaneLeft",
			"splitPaneRight": "yoKs8G_splitPaneRight",
			"tab": "yoKs8G_tab",
			"tabActive": "yoKs8G_tabActive",
			"tabBar": "yoKs8G_tabBar",
			"tabBarRight": "yoKs8G_tabBarRight",
			"tabClose": "yoKs8G_tabClose",
			"tabDot": "yoKs8G_tabDot",
			"tabDotAgent": "yoKs8G_tabDotAgent",
			"tabDotDirty": "yoKs8G_tabDotDirty",
			"tabFade": "yoKs8G_tabFade",
			"tabFadeLeft": "yoKs8G_tabFadeLeft",
			"tabFadeRight": "yoKs8G_tabFadeRight",
			"tabFavicon": "yoKs8G_tabFavicon",
			"tabInactive": "yoKs8G_tabInactive",
			"tabPlus": "yoKs8G_tabPlus",
			"tabScroll": "yoKs8G_tabScroll",
			"tabTitle": "yoKs8G_tabTitle",
			"textEditor": "yoKs8G_textEditor",
			"toolbar": "yoKs8G_toolbar",
			"toolbarBtn": "yoKs8G_toolbarBtn",
			"toolbarBtnActive": "yoKs8G_toolbarBtnActive",
			"toolbarBtnWarn": "yoKs8G_toolbarBtnWarn",
			"toolbarSpacer": "yoKs8G_toolbarSpacer",
			"truncatedNote": "yoKs8G_truncatedNote",
			"urlBar": "yoKs8G_urlBar",
			"urlFrame": "yoKs8G_urlFrame",
			"urlInput": "yoKs8G_urlInput"
		};
		...
		function downloadTab(tab) {
			...
			const href = isDataUrl ? tab.content : URL.createObjectURL(new Blob([tab.content], { type: "text/plain;charset=utf-8" }));
			...
			anchor.click();
			anchor.remove();
			if (!isDataUrl) setTimeout(() => URL.revokeObjectURL(href), 1e4);
		}
		/** The toolbar. */
		...
		function CsvViewer({ content }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
					...
					children: rows.map((row, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tr", { children: row.map((cell, cellIndex) => index === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", { children: cell }, cellIndex) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { children: cell }, cellIndex)) }, index))
				})
			});
		}
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/runner/work/dsh-web-ui/dsh-web-ui/packages/dsh-aionui-panel/src/client/styles/drag.module.css.mjs
		const css = ".cY984a_strip{box-sizing:border-box;width:100%;max-width:var(--dsh-composer-card-max-width,720px);border:1px dashed var(--aion-primary);color:var(--aion-text-primary);background-color:color-mix(in srgb, var(--aion-primary) 10%, transparent);border-radius:8px;justify-content:center;align-items:center;margin:0 auto;display:none}.cY984a_stripActive{height:26px;display:flex}.cY984a_stripText{font-size:12px;line-height:18px}";
		...
		var drag_module_css_default = {
			"strip": "cY984a_strip",
			"stripActive": "cY984a_stripActive",
			"stripText": "cY984a_stripText"
		};
		//#endregion
