...
function CsvViewer({ content }) {
    ...
    return (_jsx("div", { className: previewCss.csvViewer, children: _jsx("table", { className: previewCss.csvTable, children: rows.map((row, index) => (_jsx("tr", { children: row.map((cell, cellIndex) => (index === 0
                    ? _jsx("th", { children: cell }, cellIndex)
                    : _jsx("td", { children: cell }, cellIndex))) }, index))) }) }));
}
